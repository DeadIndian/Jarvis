...
internal class LiteRtRuntimeBridge(
    ...
    private fun createAndCacheClient(modelPath: String): LlmInference {
        synchronized(this) {
            ...
            Log.i(tag, "Creating client for $modelPath with backend: CPU")

            // mobile-actions_q8 is int8/CPU+XNNPACK. GPU backend segfaults in nativePredictSync
            // (SIGSEGV, fault addr 0x0). CPU is the correct backend for this quantized model.
